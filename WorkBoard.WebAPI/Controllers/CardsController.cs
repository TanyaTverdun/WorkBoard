...
using WorkBoard.Application.Features.Cards.Commands.UpdateCardDueDate;
...
public class CardsController : ControllerBase
{
    ...
    /// <summary>
    /// Updates the due date of a specific card
    /// </summary>
    /// <param name="boardId">
    /// The unique identifier of the board containing the card
    /// </param>
    /// <param name="cardId">
    /// The unique identifier of the card to update
    /// </param>
    /// <param name="request">
    /// The object containing the new due date for the card
    /// </param>
    /// <param name="cancellationToken">
    /// Cancellation token provided by the runtime
    /// </param>
    ...
    /// </returns>
    /// <response code="204">
    /// Returns successfully with no content when the due date is updated
    /// </response>
    /// <response code="400">
    ...
    /// </response>
    /// <response code="404">
    /// If the board or the card with the specified ID was not found
    /// </response>
    /// <response code="500">
    /// If an internal server error occurs while processing the request
    /// </response>
    [HttpPut("/api/boards/{boardId:guid}/cards/{cardId:guid}/due-date")]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    [ProducesResponseType(StatusCodes.Status403Forbidden)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [ProducesResponseType(StatusCodes.Status500InternalServerError)]
    public async Task<IActionResult> UpdateCardDueDate(
        [FromRoute] Guid boardId,
        [FromRoute] Guid cardId,
        [FromBody] UpdateCardDueDateRequest request,
        CancellationToken cancellationToken)
    {
        var command = new UpdateCardDueDateCommand
        {
            BoardId = boardId,
            CardId = cardId,
